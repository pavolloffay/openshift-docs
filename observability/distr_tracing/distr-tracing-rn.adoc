...
// https://issues.redhat.com/browse/TRACING-4108
* Added support for securing Jaeger UI and Jaeger APIs with OpenShift Oauth proxy.
// https://issues.redhat.com/browse/TRACING-3954
* Added support for using OpenShift serving certificates on ingestion APIs when multitenancy is disabled.
// https://issues.redhat.com/browse/TRACING-4171
* Added support for ingesting OpenTelemetry protocol (OTLP) JSON when multitenancy is enabled.
// https://issues.redhat.com/browse/TRACING-4176
* Added support for AWS S3 Secure Token authentication.
// https://issues.redhat.com/browse/TRACING-4185
* Added support for automatically reloading certificates.
// https://issues.redhat.com/browse/TRACING-4214
* Added support for configuring lookback for service names.
...
* Before this update, storage certificate name could not contain dot. With this update storage certificate name can contain dots (link:https://issues.redhat.com/browse/TRACING-4348[TRACING-4348]).
* Before this update, users had to select certificate when accessing gateway route. After this update the promt to select the certificate is not shown (link:https://issues.redhat.com/browse/TRACING-4431[TRACING-4431]).
* Before this update, the gateway component could not be scaled. After this update the gateway can be scaled (link:https://issues.redhat.com/browse/TRACING-4497[TRACING-4497]).
...
[id="distr-tracing_3-2-2_cves_{context}"]
=== CVEs
...
[id="distr-tracing_3-2-2_tempo-release-notes_{context}"]
=== {TempoName}

The {TempoName} is provided through the {TempoOperator}.

////
[id="distr-tracing_3-2-2_tempo-release-notes_technology-preview-features_{context}"]
==== Technology Preview features
...
////
[id="distr-tracing_3-2-2_tempo-release-notes_new-features-and-enhancements_{context}"]
==== New features and enhancements

This update introduces the following enhancements:

* {TempoName} 3.2.2 is based on the open source link:https://grafana.com/oss/tempo/[Grafana Tempo] 2.4.1.
////

////
[id="distr-tracing_3-2-2_tempo-release-notes_deprecated-functionality_{context}"]
==== Deprecated functionality

In the {TempoName} 3.2.2, ???
////

////
[id="distr-tracing_3-2-2_tempo-release-notes_removal-notice_{context}"]
==== Removal notice

In {TempoName} 3.2.2, the FEATURE has been removed. Bug fixes and support are provided only through the end of the 3.? lifecycle. As an alternative to the FEATURE for USE CASE, you can use the ALTERNATIVE instead.
////

[id="distr-tracing_3-2-2_tempo-release-notes_bug-fixes_{context}"]
==== Bug fixes
...
[id="distr-tracing_3-2-2_tempo-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_3-2-2_jaeger-release-notes_{context}"]
=== {JaegerName}
...
////
[id="distr-tracing_3-2-2_jaeger-release-notes_support-for-elasticsearch-operator_{context}"]
==== Support for {es-op}

{JaegerName} 3.2.2 is supported for use with the {es-op} 5.6, 5.7, and 5.8.
////

////
[id="distr-tracing_3-2-2_jaeger-release-notes_deprecated-functionality_{context}"]
==== Deprecated functionality
...
////
[id="distr-tracing_3-2-2_jaeger-release-notes_removal-notice_{context}"]
==== Removal notice

In {DTProductName} 3.2.2, the FEATURE has been removed. Bug fixes and support are provided only through the end of the 3.? lifecycle. As an alternative to the FEATURE for USE CASE, you can use the ALTERNATIVE instead.
////

////
[id="distr-tracing_3-2-2_jaeger-release-notes_new-features-and-enhancements_{context}"]
==== New features and enhancements

This update introduces the following enhancements for the {JaegerShortName}:

* {JaegerName} 3.2.2 is based on the open source link:https://www.jaegertracing.io/[Jaeger] release 1.57.0.
////

[id="distr-tracing_3-2-2_jaeger-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_3-2-1_{context}"]
== Release notes for {DTProductName} 3.2.1

This release of the {DTProductName} includes the {TempoName} and the deprecated {JaegerName}.

[id="distr-tracing_3-2-1_cves_{context}"]
=== CVEs

This release fixes link:https://access.redhat.com/security/cve/CVE-2024-25062/[CVE-2024-25062].

[id="distr-tracing_3-2-1_tempo-release-notes_{context}"]
=== {TempoName}

The {TempoName} is provided through the {TempoOperator}.

////
[id="distr-tracing_3-2-1_tempo-release-notes_technology-preview-features_{context}"]
==== Technology Preview features
...
////
[id="distr-tracing_3-2-1_tempo-release-notes_new-features-and-enhancements_{context}"]
==== New features and enhancements
...
////
[id="distr-tracing_3-2-1_tempo-release-notes_deprecated-functionality_{context}"]
==== Deprecated functionality
...
////
[id="distr-tracing_3-2-1_tempo-release-notes_removal-notice_{context}"]
==== Removal notice
...
////
[id="distr-tracing_3-2-1_tempo-release-notes_bug-fixes_{context}"]
==== Bug fixes
...
[id="distr-tracing_3-2-1_tempo-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_3-2-1_jaeger-release-notes_{context}"]
=== {JaegerName}
...
////
[id="distr-tracing_3-2-1_jaeger-release-notes_support-for-elasticsearch-operator_{context}"]
==== Support for {es-op}
...
////
[id="distr-tracing_3-2-1_jaeger-release-notes_deprecated-functionality_{context}"]
==== Deprecated functionality
...
////
[id="distr-tracing_3-2-1_jaeger-release-notes_removal-notice_{context}"]
==== Removal notice
...
////
[id="distr-tracing_3-2-1_jaeger-release-notes_new-features-and-enhancements_{context}"]
==== New features and enhancements
...
[id="distr-tracing_3-2-1_jaeger-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_3-2_{context}"]
== Release notes for {DTProductName} 3.2

This release of the {DTProductName} includes the {TempoName} and the deprecated {JaegerName}.

////
[id="distr-tracing_3-2_cves_{context}"]
=== CVEs

This release fixes link:https://access.redhat.com/security/cve/cve-202?-?????[CVE-202?-?????].
////

[id="distr-tracing_3-2_tempo-release-notes_{context}"]
=== {TempoName}

The {TempoName} is provided through the {TempoOperator}.

[id="distr-tracing_3-2_tempo-release-notes_technology-preview-features_{context}"]
==== Technology Preview features
...
[id="distr-tracing_3-2_tempo-release-notes_new-features-and-enhancements_{context}"]
==== New features and enhancements
...
////
[id="distr-tracing_3-2_tempo-release-notes_deprecated-functionality_{context}"]
==== Deprecated functionality
...
////
[id="distr-tracing_3-2_tempo-release-notes_removal-notice_{context}"]
==== Removal notice
...
[id="distr-tracing_3-2_tempo-release-notes_bug-fixes_{context}"]
==== Bug fixes
...
[id="distr-tracing_3-2_tempo-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_3-2_jaeger-release-notes_{context}"]
=== {JaegerName}
...
[id="distr-tracing_3-2_jaeger-release-notes_support-for-elasticsearch-operator_{context}"]
==== Support for {es-op}

{JaegerName} 3.2 is supported for use with the {es-op} 5.6, 5.7, and 5.8.

[id="distr-tracing_3-2_jaeger-release-notes_deprecated-functionality_{context}"]
==== Deprecated functionality
...
////
[id="distr-tracing_3-2_jaeger-release-notes_removal-notice_{context}"]
==== Removal notice
...
[id="distr-tracing_3-2_jaeger-release-notes_new-features-and-enhancements_{context}"]
==== New features and enhancements
...
[id="distr-tracing_3-2_jaeger-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_3-1-1_{context}"]
== Release notes for {DTProductName} 3.1.1

This release of the {DTProductName} includes the {TempoName} and the deprecated {JaegerName}.

[id="distr-tracing_3-1-1_cves_{context}"]
=== CVEs

This release fixes link:https://access.redhat.com/security/cve/cve-2023-39326[CVE-2023-39326].

// Tempo section
[id="distr-tracing_3-1-1_tempo-release-notes_{context}"]
=== {TempoName}

The {TempoName} is provided through the {TempoOperator}.

[id="distr-tracing_3-1-1_tempo-release-notes_known-issues_{context}"]
==== Known issues
...
// Jaeger section
[id="distr-tracing_3-1-1_jaeger-release-notes_{context}"]
=== {JaegerName}
...
[id="distr-tracing_3-1-1_jaeger-release-notes_support-for-elasticsearch-operator_{context}"]
==== Support for {es-op}
...
[id="distr-tracing_3-1-1_jaeger-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_3-1_{context}"]
== Release notes for {DTProductName} 3.1

This release of the {DTProductName} includes the {TempoName} and the deprecated {JaegerName}.

// Tempo section
[id="distr-tracing_3-1_tempo-release-notes_{context}"]
=== {TempoName}
...
[id="distr-tracing_3-1_tempo-release-notes_new-features-and-enhancements_{context}"]
==== New features and enhancements
...
[id="distr-tracing_3-1_tempo-release-notes_bug-fixes_{context}"]
==== Bug fixes
...
[id="distr-tracing_3-1_tempo-release-notes_known-issues_{context}"]
==== Known issues
...
// Jaeger section
[id="distr-tracing_3-1_jaeger-release-notes_{context}"]
=== {JaegerName}
...
[id="distr-tracing_3-1_jaeger-release-notes_support-for-elasticsearch-operator_{context}"]
==== Support for {es-op}
...
[id="distr-tracing_3-1_jaeger-release-notes_new-features-and-enhancements_{context}"]
==== New features and enhancements
...
[id="distr-tracing_3-1_jaeger-release-notes_bug-fixes_{context}"]
==== Bug fixes
...
[id="distr-tracing_3-1_jaeger-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_3.0_{context}"]
== Release notes for {DTProductName} 3.0

[id="distr-tracing_3-0_component-versions_{context}"]
...
// Jaeger section
[id="distr-tracing_3-0_jaeger-release-notes_{context}"]
=== {JaegerName}
...
[id="distr-tracing_3-0_jaeger-release-notes_new-features-and-enhancements_{context}"]
==== New features and enhancements
...
[id="distr-tracing_3-0_jaeger-release-notes_bug-fixes_{context}"]
==== Bug fixes
...
[id="distr-tracing_3-0_jaeger-release-notes_known-issues_{context}"]
==== Known issues
...
// Tempo section
[id="distr-tracing_3-0_tempo-release-notes_{context}"]
=== {TempoName}

[id="distr-tracing_3-0_tempo-release-notes_new-features-and-enhancements_{context}"]
==== New features and enhancements
...
[id="distr-tracing_3-0_tempo-release-notes_bug-fixes_{context}"]
==== Bug fixes
...
[id="distr-tracing_3-0_tempo-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_2-9-2_{context}"]
== Release notes for {DTProductName} 2.9.2

[id="distr-tracing_2-9-2_component-versions_{context}"]
...
[id="distr-tracing_2-9-2_jaeger-release-notes_{context}"]
=== {JaegerName}

[id="distr-tracing_2-9-2_jaeger-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_2-9-2_tempo-release-notes_{context}"]
=== {TempoName}

:FeatureName: The {TempoName}
include::snippets/technology-preview.adoc[leveloffset=+1]

[id="distr-tracing_2-9-2_tempo-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_2-9-1_{context}"]
== Release notes for {DTProductName} 2.9.1

[id="distr-tracing_2-9-1_component-versions_{context}"]
...
[id="distr-tracing_2-9-1_jaeger-release-notes_{context}"]
=== {JaegerName}

[id="distr-tracing_2-9-1_jaeger-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_2-9-1_tempo-release-notes_{context}"]
=== {TempoName}

:FeatureName: The {TempoName}
include::snippets/technology-preview.adoc[leveloffset=+1]

[id="distr-tracing_2-9-1_tempo-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_2-9_{context}"]
== Release notes for {DTProductName} 2.9

[id="distr-tracing_2-9_component-versions_{context}"]
...
[id="distr-tracing_2-9_jaeger-release-notes_{context}"]
=== {JaegerName}

////
[id="distr-tracing_2-9_jaeger-release-notes_new-features-and-enhancements_{context}"]
==== New features and enhancements
* None.
////
...
[id="distr-tracing_2-9_jaeger-release-notes_bug-fixes_{context}"]
==== Bug fixes
...
[id="distr-tracing_2-9_jaeger-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_2-9_tempo-release-notes_{context}"]
=== {TempoName}

:FeatureName: The {TempoName}
include::snippets/technology-preview.adoc[leveloffset=+1]

[id="distr-tracing_2-9_tempo-release-notes_new-features-and-enhancements_{context}"]
==== New features and enhancements
...
////
[id="2-9_tempo-release-notes_technology-preview-features_{context}"]
=== Technology Preview features
None.
////

[id="distr-tracing_2-9_tempo-release-notes_bug-fixes_{context}"]
==== Bug fixes
...
[id="distr-tracing_2-9_tempo-release-notes_known-issues_{context}"]
==== Known issues
...
[id="distr-tracing_2-8_{context}"]
== Release notes for {DTProductName} 2.8

[id="distr-tracing_2-8_component-versions_{context}"]
...
[id="distr-tracing_2-8_technology-preview-features_{context}"]
=== Technology Preview features
...
[id="distr-tracing_2-8_bug-fixes_{context}"]
=== Bug fixes

This release addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

[id="distr-tracing_2-7_{context}"]
== Release notes for {DTProductName} 2.7

[id="distr-tracing_2-7_component-versions_{context}"]
...
[id="distr-tracing_2-7_bug-fixes_{context}"]
=== Bug fixes

This release addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

[id="distr-tracing_2-6_{context}"]
== Release notes for {DTProductName} 2.6

[id="distr-tracing_2-6_component-versions_{context}"]
...
[id="distr-tracing_2-6_bug-fixes_{context}"]
=== Bug fixes

This release addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

[id="distr-tracing_2-5_{context}"]
== Release notes for {DTProductName} 2.5

[id="distr-tracing_2-5_component-versions_{context}"]
...
[id="distr-tracing_2-5_new-features-and-enhancements_{context}"]
=== New features and enhancements
...
[id="distr-tracing_2-5_bug-fixes_{context}"]
=== Bug fixes

This release addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

[id="distr-tracing_2-4_{context}"]
== Release notes for {DTProductName} 2.4

[id="distr-tracing_2-4_component-versions_{context}"]
...
[id="distr-tracing_2-4_new-features-and-enhancements_{context}"]
=== New features and enhancements
...
[id="distr-tracing_2-4_technology-preview-features_{context}"]
=== Technology Preview features
...
[id="distr-tracing_2-4_bug-fixes_{context}"]
=== Bug fixes

This release addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

[id="distr-tracing_2-3_{context}"]
== Release notes for {DTProductName} 2.3

[id="distr-tracing_2-3_component-versions_2-3-1_{context}"]
...
[id="distr-tracing_2-3_component-versions_2-3-0_{context}"]
...
[id="distr-tracing_2-3_new-features-and-enhancements_{context}"]
=== New features and enhancements
...
[id="distr-tracing_2-1_technology-preview-features_{context}"]
=== Technology Preview features
...
[id="distr-tracing_2-1_bug-fixes_{context}"]
=== Bug fixes

This release addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

[id="distr-tracing_2-0_{context}"]
== Release notes for {DTProductName} 2.0

[id="distr-tracing_2-0_component-versions_{context}"]
...
[id="distr-tracing_2-0_new-features-and-enhancements_{context}"]
=== New features and enhancements
...
[id="distr-tracing_2-0_technology-preview-features_{context}"]
=== Technology Preview features
...
[id="distr-tracing_2-0_bug-fixes_{context}"]
=== Bug fixes
