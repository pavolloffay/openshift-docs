...
* link:https://access.redhat.com/security/cve/CVE-2024-6104[CVE-2024-6104], link:https://issues.redhat.com/browse/TRACING-4401[TRACING-4401]
...
* Exporting logs to OpenShift LokiStack log store
* Rounting connector
...
// https://issues.redhat.com/browse/TRACING-3768
* Collector dashboard for internal collector metrics. The dashboard helps to analyze collector health and performance.
// https://issues.redhat.com/browse/TRACING-3898
* The operator is capable of automatically creating RBAC for collector components that require custom RBAC.
...
* This patch fixes creation of `ServiceMonitor` custom resource when operator monitoring is enabled (link:https://issues.redhat.com/browse/TRACING-4288[TRACING-4288])
