...
The Logging exporter prints traces and metrics to the standard output.
...
This extension supports traces, metrics, logs.
...
The OAuth2Client extension is currently a link:https://access.redhat.com/support/offerings/devpreview[Developer Preview] feature only.
...
The Performance Profiler extension is currently a link:https://access.redhat.com/support/offerings/devpreview[Developer Preview] feature only.
...
The zPages extension is currently a link:https://access.redhat.com/support/offerings/devpreview[Developer Preview] feature only.
