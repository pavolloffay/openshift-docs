...
include::modules/distr-tracing-otel-troubleshoot-collector-logs.adoc[leveloffset=+1]
include::modules/distr-tracing-otel-troubleshoot-metrics.adoc[leveloffset=+1]
include::modules/distr-tracing-otel-troubleshoot-logging-exporter-stdout.adoc[leveloffset=+1]
